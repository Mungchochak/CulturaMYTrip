...
public class DeepSeekPromptModel {
    ...
    public String getCultureprompt(String cultureName) {
    ...
    public String getBudgetprompt() {
        ...
        return "You are a professional Malaysian travel assistant system. Based on the provided travel plan, estimate a suitable **total travel cost range** in US Dollars (USD) for the user.\n\n"
